...
$(CONFIG)/obj/actionHandler.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/actionHandler.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/actionHandler.c
...
$(CONFIG)/obj/auth.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/auth.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/auth.c
...
$(CONFIG)/obj/basic.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/basic.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/basic.c
...
$(CONFIG)/obj/cache.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/cache.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/cache.c
...
$(CONFIG)/obj/chunkFilter.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/chunkFilter.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/chunkFilter.c
...
$(CONFIG)/obj/client.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/client.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/client.c
...
$(CONFIG)/obj/conn.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/conn.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/conn.c
...
$(CONFIG)/obj/digest.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/digest.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/digest.c
...
$(CONFIG)/obj/endpoint.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/endpoint.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/endpoint.c
...
$(CONFIG)/obj/error.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/error.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/error.c
...
$(CONFIG)/obj/host.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/host.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/host.c
...
$(CONFIG)/obj/monitor.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/monitor.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/monitor.c
...
$(CONFIG)/obj/netConnector.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/netConnector.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/netConnector.c
...
$(CONFIG)/obj/packet.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/packet.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/packet.c
...
$(CONFIG)/obj/pam.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pam.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/pam.c
...
$(CONFIG)/obj/passHandler.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/passHandler.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/passHandler.c
...
$(CONFIG)/obj/pipeline.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pipeline.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/pipeline.c
...
$(CONFIG)/obj/queue.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/queue.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/queue.c
...
$(CONFIG)/obj/rangeFilter.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/rangeFilter.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/rangeFilter.c
...
$(CONFIG)/obj/route.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/route.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/route.c
...
$(CONFIG)/obj/rx.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/rx.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/rx.c
...
$(CONFIG)/obj/sendConnector.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sendConnector.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/sendConnector.c
...
$(CONFIG)/obj/service.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/service.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/service.c
...
$(CONFIG)/obj/session.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/session.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/session.c
...
$(CONFIG)/obj/stage.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/stage.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/stage.c
...
$(CONFIG)/obj/trace.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/trace.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/trace.c
...
$(CONFIG)/obj/tx.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/tx.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/tx.c
...
$(CONFIG)/obj/uploadFilter.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/uploadFilter.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/uploadFilter.c
...
$(CONFIG)/obj/uri.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/uri.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/uri.c
...
$(CONFIG)/obj/var.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/var.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/var.c
...
$(CONFIG)/obj/webSockFilter.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/webSockFilter.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/webSockFilter.c
...
$(CONFIG)/obj/http.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/http.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) src/http.c
...
$(CONFIG)/obj/testHttpGen.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/testHttpGen.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) test/src/testHttpGen.c
...
$(CONFIG)/obj/testHttpUri.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/testHttpUri.o $(LDFLAGS) -fPIC $(DFLAGS) $(IFLAGS) test/src/testHttpUri.c
