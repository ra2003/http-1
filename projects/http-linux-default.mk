...
prep:
	...
	@[ ! -f $(CONFIG)/inc/me.h ] && cp projects/http-linux-default-me.h $(CONFIG)/inc/me.h ; true
	@if ! diff $(CONFIG)/inc/me.h projects/http-linux-default-me.h >/dev/null ; then\
		cp projects/http-linux-default-me.h $(CONFIG)/inc/me.h  ; \
	fi; true
...
$(CONFIG)/bin/http: $(DEPS_44)
	...
	$(CC) -o $(CONFIG)/bin/http $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_44) $(LIBS_44) $(LIBS_44) $(LIBS) $(LIBS) 
