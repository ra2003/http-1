...
build/$(CONFIG)/obj/actionHandler.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/actionHandler.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/actionHandler.c
...
build/$(CONFIG)/obj/auth.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/auth.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/auth.c
...
build/$(CONFIG)/obj/basic.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/basic.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/basic.c
...
build/$(CONFIG)/obj/cache.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/cache.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/cache.c
...
build/$(CONFIG)/obj/chunkFilter.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/chunkFilter.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/chunkFilter.c
...
build/$(CONFIG)/obj/client.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/client.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/client.c
...
build/$(CONFIG)/obj/conn.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/conn.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/conn.c
...
build/$(CONFIG)/obj/digest.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/digest.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/digest.c
...
build/$(CONFIG)/obj/endpoint.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/endpoint.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/endpoint.c
...
build/$(CONFIG)/obj/error.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/error.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/error.c
...
build/$(CONFIG)/obj/host.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/host.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/host.c
...
build/$(CONFIG)/obj/monitor.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/monitor.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/monitor.c
...
build/$(CONFIG)/obj/netConnector.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/netConnector.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/netConnector.c
...
build/$(CONFIG)/obj/packet.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/packet.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/packet.c
...
build/$(CONFIG)/obj/pam.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pam.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pam.c
...
build/$(CONFIG)/obj/passHandler.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/passHandler.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/passHandler.c
...
build/$(CONFIG)/obj/pipeline.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/pipeline.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/pipeline.c
...
build/$(CONFIG)/obj/queue.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/queue.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/queue.c
...
build/$(CONFIG)/obj/rangeFilter.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/rangeFilter.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/rangeFilter.c
...
build/$(CONFIG)/obj/route.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/route.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/route.c
...
build/$(CONFIG)/obj/rx.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/rx.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/rx.c
...
build/$(CONFIG)/obj/sendConnector.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/sendConnector.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/sendConnector.c
...
build/$(CONFIG)/obj/service.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/service.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/service.c
...
build/$(CONFIG)/obj/session.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/session.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/session.c
...
build/$(CONFIG)/obj/stage.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/stage.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/stage.c
...
build/$(CONFIG)/obj/trace.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/trace.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/trace.c
...
build/$(CONFIG)/obj/tx.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/tx.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/tx.c
...
build/$(CONFIG)/obj/uploadFilter.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/uploadFilter.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/uploadFilter.c
...
build/$(CONFIG)/obj/uri.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/uri.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/uri.c
...
build/$(CONFIG)/obj/user.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/user.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/user.c
...
build/$(CONFIG)/obj/var.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/var.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/var.c
...
build/$(CONFIG)/obj/webSockFilter.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/webSockFilter.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/webSockFilter.c
...
build/$(CONFIG)/obj/http.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/http.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/http.c
...
DEPS_46 += build/$(CONFIG)/bin/libhttp.so
...
build/$(CONFIG)/bin/http: $(DEPS_46)
	...
	$(CC) -o build/$(CONFIG)/bin/http $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/http.o" $(LIBPATHS_46) $(LIBS_46) $(LIBS_46) $(LIBS) $(LIBS) 
...
build/$(CONFIG)/bin/libest.so: $(DEPS_49)
...
DEPS_51 += build/$(CONFIG)/bin/libmpr.so
DEPS_51 += build/$(CONFIG)/inc/est.h
DEPS_51 += build/$(CONFIG)/obj/estLib.o
ifeq ($(ME_COM_EST),1)
    DEPS_51 += build/$(CONFIG)/bin/libest.so
endif
...
build/$(CONFIG)/bin/libmprssl.so: $(DEPS_51)
	@echo '      [Link] build/$(CONFIG)/bin/libmprssl.so'
	$(CC) -shared -o build/$(CONFIG)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS)    "build/$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) 
