...
$(BUILD)/obj/http-server.o: \
	...
	$(CC) -c -o $(BUILD)/obj/http-server.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) test/http-server.c
...
$(BUILD)/obj/sendConnector.o: \
	...
	$(CC) -c -o $(BUILD)/obj/sendConnector.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/sendConnector.c
