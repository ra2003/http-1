...
$(BUILD)/obj/actionHandler.o: \
	...
	$(CC) -c -o $(BUILD)/obj/actionHandler.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/actionHandler.c
...
$(BUILD)/obj/auth.o: \
	...
	$(CC) -c -o $(BUILD)/obj/auth.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/auth.c
...
$(BUILD)/obj/basic.o: \
	...
	$(CC) -c -o $(BUILD)/obj/basic.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/basic.c
...
$(BUILD)/obj/cache.o: \
	...
	$(CC) -c -o $(BUILD)/obj/cache.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/cache.c
...
$(BUILD)/obj/chunkFilter.o: \
	...
	$(CC) -c -o $(BUILD)/obj/chunkFilter.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/chunkFilter.c
...
$(BUILD)/obj/client.o: \
	...
	$(CC) -c -o $(BUILD)/obj/client.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/client.c
...
$(BUILD)/obj/conn.o: \
	...
	$(CC) -c -o $(BUILD)/obj/conn.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/conn.c
...
$(BUILD)/obj/digest.o: \
	...
	$(CC) -c -o $(BUILD)/obj/digest.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/digest.c
...
$(BUILD)/obj/dirHandler.o: \
	...
	$(CC) -c -o $(BUILD)/obj/dirHandler.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/dirHandler.c
...
$(BUILD)/obj/endpoint.o: \
	...
	$(CC) -c -o $(BUILD)/obj/endpoint.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/endpoint.c
...
$(BUILD)/obj/error.o: \
	...
	$(CC) -c -o $(BUILD)/obj/error.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/error.c
...
$(BUILD)/obj/fileHandler.o: \
	...
	$(CC) -c -o $(BUILD)/obj/fileHandler.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/fileHandler.c
...
$(BUILD)/obj/host.o: \
	...
	$(CC) -c -o $(BUILD)/obj/host.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/host.c
...
$(BUILD)/obj/hpack.o: \
	...
	$(CC) -c -o $(BUILD)/obj/hpack.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/hpack.c
...
$(BUILD)/obj/http.o: \
	...
	$(CC) -c -o $(BUILD)/obj/http.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/http.c
...
$(BUILD)/obj/http1Filter.o: \
	...
	$(CC) -c -o $(BUILD)/obj/http1Filter.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/http1Filter.c
...
$(BUILD)/obj/http2Filter.o: \
	...
	$(CC) -c -o $(BUILD)/obj/http2Filter.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/http2Filter.c
...
$(BUILD)/obj/huff.o: \
	...
	$(CC) -c -o $(BUILD)/obj/huff.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/huff.c
...
$(BUILD)/obj/monitor.o: \
	...
	$(CC) -c -o $(BUILD)/obj/monitor.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/monitor.c
...
$(BUILD)/obj/net.o: \
	...
	$(CC) -c -o $(BUILD)/obj/net.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/net.c
...
$(BUILD)/obj/netConnector.o: \
	...
	$(CC) -c -o $(BUILD)/obj/netConnector.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/netConnector.c
...
$(BUILD)/obj/packet.o: \
	...
	$(CC) -c -o $(BUILD)/obj/packet.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/packet.c
...
$(BUILD)/obj/pam.o: \
	...
	$(CC) -c -o $(BUILD)/obj/pam.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/pam.c
...
$(BUILD)/obj/passHandler.o: \
	...
	$(CC) -c -o $(BUILD)/obj/passHandler.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/passHandler.c
...
$(BUILD)/obj/pipeline.o: \
	...
	$(CC) -c -o $(BUILD)/obj/pipeline.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/pipeline.c
...
$(BUILD)/obj/process.o: \
	...
	$(CC) -c -o $(BUILD)/obj/process.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/process.c
...
$(BUILD)/obj/queue.o: \
	...
	$(CC) -c -o $(BUILD)/obj/queue.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/queue.c
...
$(BUILD)/obj/rangeFilter.o: \
	...
	$(CC) -c -o $(BUILD)/obj/rangeFilter.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/rangeFilter.c
...
$(BUILD)/obj/route.o: \
	...
	$(CC) -c -o $(BUILD)/obj/route.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/route.c
...
$(BUILD)/obj/rx.o: \
	...
	$(CC) -c -o $(BUILD)/obj/rx.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/rx.c
...
$(BUILD)/obj/server.o: \
	...
	$(CC) -c -o $(BUILD)/obj/server.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/server.c
...
$(BUILD)/obj/service.o: \
	...
	$(CC) -c -o $(BUILD)/obj/service.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/service.c
...
$(BUILD)/obj/session.o: \
	...
	$(CC) -c -o $(BUILD)/obj/session.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/session.c
...
$(BUILD)/obj/stage.o: \
	...
	$(CC) -c -o $(BUILD)/obj/stage.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/stage.c
...
$(BUILD)/obj/tailFilter.o: \
	...
	$(CC) -c -o $(BUILD)/obj/tailFilter.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/tailFilter.c
...
$(BUILD)/obj/trace.o: \
	...
	$(CC) -c -o $(BUILD)/obj/trace.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/trace.c
...
$(BUILD)/obj/tx.o: \
	...
	$(CC) -c -o $(BUILD)/obj/tx.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/tx.c
...
$(BUILD)/obj/uploadFilter.o: \
	...
	$(CC) -c -o $(BUILD)/obj/uploadFilter.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/uploadFilter.c
...
$(BUILD)/obj/uri.o: \
	...
	$(CC) -c -o $(BUILD)/obj/uri.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/uri.c
...
$(BUILD)/obj/user.o: \
	...
	$(CC) -c -o $(BUILD)/obj/user.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/user.c
...
$(BUILD)/obj/var.o: \
	...
	$(CC) -c -o $(BUILD)/obj/var.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/var.c
...
$(BUILD)/obj/webSockFilter.o: \
	...
	$(CC) -c -o $(BUILD)/obj/webSockFilter.o $(LDFLAGS) $(DFLAGS) -D_FILE_OFFSET_BITS=64 -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/webSockFilter.c
