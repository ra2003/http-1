...
CFLAGS                += -g -w
DFLAGS                +=  $(patsubst %,-D%,$(filter ME_%,$(MAKEFLAGS))) -DME_COM_EST=$(ME_COM_EST) -DME_COM_MATRIXSSL=$(ME_COM_MATRIXSSL) -DME_COM_NANOSSL=$(ME_COM_NANOSSL) -DME_COM_OPENSSL=$(ME_COM_OPENSSL) -DME_COM_OSDEP=$(ME_COM_OSDEP) -DME_COM_PCRE=$(ME_COM_PCRE) -DME_COM_SSL=$(ME_COM_SSL) -DME_COM_VXWORKS=$(ME_COM_VXWORKS) -DME_COM_WINSDK=$(ME_COM_WINSDK) 
...
build/$(CONFIG)/obj/actionHandler.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/actionHandler.o $(LDFLAGS) $(IFLAGS) src/actionHandler.c
...
build/$(CONFIG)/obj/auth.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/auth.o $(LDFLAGS) $(IFLAGS) src/auth.c
...
build/$(CONFIG)/obj/basic.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/basic.o $(LDFLAGS) $(IFLAGS) src/basic.c
...
build/$(CONFIG)/obj/cache.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/cache.o $(LDFLAGS) $(IFLAGS) src/cache.c
...
build/$(CONFIG)/obj/chunkFilter.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/chunkFilter.o $(LDFLAGS) $(IFLAGS) src/chunkFilter.c
...
build/$(CONFIG)/obj/client.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/client.o $(LDFLAGS) $(IFLAGS) src/client.c
...
build/$(CONFIG)/obj/conn.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/conn.o $(LDFLAGS) $(IFLAGS) src/conn.c
...
build/$(CONFIG)/obj/digest.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/digest.o $(LDFLAGS) $(IFLAGS) src/digest.c
...
build/$(CONFIG)/obj/endpoint.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/endpoint.o $(LDFLAGS) $(IFLAGS) src/endpoint.c
...
build/$(CONFIG)/obj/error.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/error.o $(LDFLAGS) $(IFLAGS) src/error.c
...
build/$(CONFIG)/obj/host.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/host.o $(LDFLAGS) $(IFLAGS) src/host.c
...
build/$(CONFIG)/obj/monitor.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/monitor.o $(LDFLAGS) $(IFLAGS) src/monitor.c
...
build/$(CONFIG)/obj/netConnector.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/netConnector.o $(LDFLAGS) $(IFLAGS) src/netConnector.c
...
build/$(CONFIG)/obj/packet.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/packet.o $(LDFLAGS) $(IFLAGS) src/packet.c
...
build/$(CONFIG)/obj/pam.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/pam.o $(LDFLAGS) $(IFLAGS) src/pam.c
...
build/$(CONFIG)/obj/passHandler.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/passHandler.o $(LDFLAGS) $(IFLAGS) src/passHandler.c
...
build/$(CONFIG)/obj/pipeline.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/pipeline.o $(LDFLAGS) $(IFLAGS) src/pipeline.c
...
build/$(CONFIG)/obj/queue.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/queue.o $(LDFLAGS) $(IFLAGS) src/queue.c
...
build/$(CONFIG)/obj/rangeFilter.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/rangeFilter.o $(LDFLAGS) $(IFLAGS) src/rangeFilter.c
...
build/$(CONFIG)/obj/route.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/route.o $(LDFLAGS) $(IFLAGS) src/route.c
...
build/$(CONFIG)/obj/rx.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/rx.o $(LDFLAGS) $(IFLAGS) src/rx.c
...
build/$(CONFIG)/obj/sendConnector.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/sendConnector.o $(LDFLAGS) $(IFLAGS) src/sendConnector.c
...
build/$(CONFIG)/obj/service.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/service.o $(LDFLAGS) $(IFLAGS) src/service.c
...
build/$(CONFIG)/obj/session.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/session.o $(LDFLAGS) $(IFLAGS) src/session.c
...
build/$(CONFIG)/obj/stage.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/stage.o $(LDFLAGS) $(IFLAGS) src/stage.c
...
build/$(CONFIG)/obj/trace.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/trace.o $(LDFLAGS) $(IFLAGS) src/trace.c
...
build/$(CONFIG)/obj/tx.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/tx.o $(LDFLAGS) $(IFLAGS) src/tx.c
...
build/$(CONFIG)/obj/uploadFilter.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/uploadFilter.o $(LDFLAGS) $(IFLAGS) src/uploadFilter.c
...
build/$(CONFIG)/obj/uri.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/uri.o $(LDFLAGS) $(IFLAGS) src/uri.c
...
build/$(CONFIG)/obj/user.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/user.o $(LDFLAGS) $(IFLAGS) src/user.c
...
build/$(CONFIG)/obj/var.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/var.o $(LDFLAGS) $(IFLAGS) src/var.c
...
build/$(CONFIG)/obj/webSockFilter.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/webSockFilter.o $(LDFLAGS) $(IFLAGS) src/webSockFilter.c
...
build/$(CONFIG)/obj/http-server.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/http-server.o $(LDFLAGS) $(IFLAGS) test/http-server.c
...
build/$(CONFIG)/obj/http.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/http.o $(LDFLAGS) $(IFLAGS) src/http.c
