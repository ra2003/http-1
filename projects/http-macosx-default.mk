...
$(CONFIG)/bin/libpcre.dylib: $(DEPS_10)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libpcre.dylib $(LDFLAGS) -compatibility_version 1.3.0 -current_version 1.3.0 $(LIBPATHS) -install_name @rpath/libpcre.dylib -compatibility_version 1.3.0 -current_version 1.3.0 $(CONFIG)/obj/pcre.o $(LIBS) 
endif
...
#
ifeq ($(BIT_PACK_EST),1)
    DEPS_14 += $(CONFIG)/bin/libest.dylib
endif
...
ifeq ($(BIT_PACK_MATRIXSSL),1)
    LIBS_17 += -lmatrixssl
    LIBPATHS_17 += -L$(BIT_PACK_MATRIXSSL_PATH)
endif
ifeq ($(BIT_PACK_NANOSSL),1)
    LIBS_17 += -lssls
    LIBPATHS_17 += -L$(BIT_PACK_NANOSSL_PATH)/bin
endif
ifeq ($(BIT_PACK_OPENSSL),1)
    LIBS_17 += -lssl
    LIBPATHS_17 += -L$(BIT_PACK_OPENSSL_PATH)
endif
ifeq ($(BIT_PACK_OPENSSL),1)
    LIBS_17 += -lcrypto
    LIBPATHS_17 += -L$(BIT_PACK_OPENSSL_PATH)
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_17)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 1.3.0 -current_version 1.3.0 $(CONFIG)/obj/mprSsl.o $(LIBPATHS_17) $(LIBS_17) $(LIBS_17) $(LIBS) 
...
$(CONFIG)/bin/makerom: $(DEPS_19)
	...
	$(CC) -o $(CONFIG)/bin/makerom -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBPATHS_19) $(LIBS_19) $(LIBS_19) $(LIBS) 
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_54)
	@echo '      [Link] $(CONFIG)/bin/libhttp.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 1.3.0 -current_version 1.3.0 $(CONFIG)/obj/actionHandler.o $(CONFIG)/obj/auth.o $(CONFIG)/obj/basic.o $(CONFIG)/obj/cache.o $(CONFIG)/obj/chunkFilter.o $(CONFIG)/obj/client.o $(CONFIG)/obj/conn.o $(CONFIG)/obj/digest.o $(CONFIG)/obj/endpoint.o $(CONFIG)/obj/error.o $(CONFIG)/obj/host.o $(CONFIG)/obj/httpService.o $(CONFIG)/obj/log.o $(CONFIG)/obj/netConnector.o $(CONFIG)/obj/packet.o $(CONFIG)/obj/pam.o $(CONFIG)/obj/passHandler.o $(CONFIG)/obj/pipeline.o $(CONFIG)/obj/queue.o $(CONFIG)/obj/rangeFilter.o $(CONFIG)/obj/route.o $(CONFIG)/obj/rx.o $(CONFIG)/obj/sendConnector.o $(CONFIG)/obj/session.o $(CONFIG)/obj/stage.o $(CONFIG)/obj/trace.o $(CONFIG)/obj/tx.o $(CONFIG)/obj/uploadFilter.o $(CONFIG)/obj/uri.o $(CONFIG)/obj/var.o $(CONFIG)/obj/webSock.o $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/http: $(DEPS_56)
	...
	$(CC) -o $(CONFIG)/bin/http -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/http.o $(LIBPATHS_56) $(LIBS_56) $(LIBS_56) $(LIBS) 
