...
prep:
	...
	@[ ! -f $(CONFIG)/inc/me.h ] && cp projects/http-macosx-default-me.h $(CONFIG)/inc/me.h ; true
	@if ! diff $(CONFIG)/inc/me.h projects/http-macosx-default-me.h >/dev/null ; then\
		cp projects/http-macosx-default-me.h $(CONFIG)/inc/me.h  ; \
	fi; true
...
$(CONFIG)/obj/actionHandler.o: \
    src/actionHandler.c $(DEPS_10)
	@echo '   [Compile] $(CONFIG)/obj/actionHandler.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/actionHandler.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/actionHandler.c
...
$(CONFIG)/obj/auth.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/auth.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/auth.c
...
$(CONFIG)/obj/basic.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/basic.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/basic.c
...
$(CONFIG)/obj/cache.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/cache.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/cache.c
...
$(CONFIG)/obj/chunkFilter.o: \
    src/chunkFilter.c $(DEPS_14)
	@echo '   [Compile] $(CONFIG)/obj/chunkFilter.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/chunkFilter.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/chunkFilter.c
...
$(CONFIG)/obj/client.o: \
    src/client.c $(DEPS_15)
	@echo '   [Compile] $(CONFIG)/obj/client.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/client.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/client.c
...
$(CONFIG)/obj/conn.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/conn.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/conn.c
...
$(CONFIG)/obj/digest.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/digest.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/digest.c
...
$(CONFIG)/obj/endpoint.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/endpoint.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/endpoint.c
...
$(CONFIG)/obj/error.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/error.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/error.c
...
$(CONFIG)/obj/host.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/host.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/host.c
...
$(CONFIG)/obj/monitor.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/monitor.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/monitor.c
...
$(CONFIG)/obj/netConnector.o: \
    src/netConnector.c $(DEPS_23)
	@echo '   [Compile] $(CONFIG)/obj/netConnector.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/netConnector.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/netConnector.c
...
$(CONFIG)/obj/packet.o: \
    src/packet.c $(DEPS_24)
	@echo '   [Compile] $(CONFIG)/obj/packet.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/packet.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/packet.c
...
$(CONFIG)/obj/pam.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/pam.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/pam.c
...
$(CONFIG)/obj/passHandler.o: \
    src/passHandler.c $(DEPS_26)
	@echo '   [Compile] $(CONFIG)/obj/passHandler.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/passHandler.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/passHandler.c
...
$(CONFIG)/obj/pipeline.o: \
    src/pipeline.c $(DEPS_27)
	@echo '   [Compile] $(CONFIG)/obj/pipeline.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/pipeline.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/pipeline.c
...
$(CONFIG)/obj/queue.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/queue.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/queue.c
...
$(CONFIG)/obj/rangeFilter.o: \
    src/rangeFilter.c $(DEPS_29)
	@echo '   [Compile] $(CONFIG)/obj/rangeFilter.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/rangeFilter.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/rangeFilter.c
...
$(CONFIG)/obj/route.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/route.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/route.c
...
$(CONFIG)/obj/rx.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/rx.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/rx.c
...
$(CONFIG)/obj/sendConnector.o: \
    src/sendConnector.c $(DEPS_32)
	@echo '   [Compile] $(CONFIG)/obj/sendConnector.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/sendConnector.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/sendConnector.c
...
$(CONFIG)/obj/service.o: \
    src/service.c $(DEPS_33)
	@echo '   [Compile] $(CONFIG)/obj/service.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/service.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/service.c
...
$(CONFIG)/obj/session.o: \
    src/session.c $(DEPS_34)
	@echo '   [Compile] $(CONFIG)/obj/session.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/session.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/session.c
...
$(CONFIG)/obj/stage.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/stage.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/stage.c
...
$(CONFIG)/obj/trace.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/trace.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/trace.c
...
$(CONFIG)/obj/tx.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/tx.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/tx.c
...
$(CONFIG)/obj/uploadFilter.o: \
    src/uploadFilter.c $(DEPS_38)
	@echo '   [Compile] $(CONFIG)/obj/uploadFilter.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/uploadFilter.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/uploadFilter.c
...
$(CONFIG)/obj/uri.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/uri.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/uri.c
...
$(CONFIG)/obj/var.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/var.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/var.c
...
$(CONFIG)/obj/webSockFilter.o: \
    src/webSockFilter.c $(DEPS_41)
	@echo '   [Compile] $(CONFIG)/obj/webSockFilter.o'
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/webSockFilter.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/webSockFilter.c
...
DEPS_42 += $(CONFIG)/obj/actionHandler.o
DEPS_42 += $(CONFIG)/obj/auth.o
DEPS_42 += $(CONFIG)/obj/basic.o
DEPS_42 += $(CONFIG)/obj/cache.o
DEPS_42 += $(CONFIG)/obj/chunkFilter.o
DEPS_42 += $(CONFIG)/obj/client.o
DEPS_42 += $(CONFIG)/obj/conn.o
DEPS_42 += $(CONFIG)/obj/digest.o
DEPS_42 += $(CONFIG)/obj/endpoint.o
DEPS_42 += $(CONFIG)/obj/error.o
DEPS_42 += $(CONFIG)/obj/host.o
DEPS_42 += $(CONFIG)/obj/log.o
DEPS_42 += $(CONFIG)/obj/monitor.o
DEPS_42 += $(CONFIG)/obj/netConnector.o
DEPS_42 += $(CONFIG)/obj/packet.o
DEPS_42 += $(CONFIG)/obj/pam.o
DEPS_42 += $(CONFIG)/obj/passHandler.o
DEPS_42 += $(CONFIG)/obj/pipeline.o
DEPS_42 += $(CONFIG)/obj/queue.o
DEPS_42 += $(CONFIG)/obj/rangeFilter.o
DEPS_42 += $(CONFIG)/obj/route.o
DEPS_42 += $(CONFIG)/obj/rx.o
DEPS_42 += $(CONFIG)/obj/sendConnector.o
DEPS_42 += $(CONFIG)/obj/service.o
DEPS_42 += $(CONFIG)/obj/session.o
DEPS_42 += $(CONFIG)/obj/stage.o
DEPS_42 += $(CONFIG)/obj/trace.o
DEPS_42 += $(CONFIG)/obj/tx.o
DEPS_42 += $(CONFIG)/obj/uploadFilter.o
DEPS_42 += $(CONFIG)/obj/uri.o
DEPS_42 += $(CONFIG)/obj/var.o
DEPS_42 += $(CONFIG)/obj/webSockFilter.o
...
$(CONFIG)/obj/http.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/http.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/http.c
...
$(CONFIG)/bin/http: $(DEPS_44)
	@echo '      [Link] $(CONFIG)/bin/http'
	$(CC) -o $(CONFIG)/bin/http -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_44) $(LIBS_44) $(LIBS_44) $(LIBS) 

#
#   est.h
#
$(CONFIG)/inc/est.h: $(DEPS_45)
...
$(CONFIG)/bin/libest.dylib: $(DEPS_47)
...
ifeq ($(ME_COM_EST),1)
    DEPS_49 += $(CONFIG)/bin/libest.dylib
endif
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_49)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 5.0.0 -current_version 5.0.0 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_49) $(LIBS_49) $(LIBS_49) $(LIBS) 
...
$(CONFIG)/obj/testHttpGen.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/testHttpGen.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) test/src/testHttpGen.c
...
$(CONFIG)/obj/testHttpUri.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/testHttpUri.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) test/src/testHttpUri.c
...
$(CONFIG)/bin/testHttp: $(DEPS_53)
	...
	$(CC) -o $(CONFIG)/bin/testHttp -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/testHttp.o" "$(CONFIG)/obj/testHttpGen.o" "$(CONFIG)/obj/testHttpUri.o" $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) 
