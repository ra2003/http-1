...
DEPS_51 += $(CONFIG)/obj/httpService.o
...
$(CONFIG)/bin/http: $(DEPS_53)
	...
	$(CC) -o $(CONFIG)/bin/http -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) 
