...
ifeq ($(ME_COM_EST),1)
    DEPS_50 += $(CONFIG)/bin/libest.dylib
endif
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_50)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 5.0 -current_version 5.0 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) 
