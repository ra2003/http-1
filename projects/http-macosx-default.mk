...
$(CONFIG)/obj/estLib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/estLib.o -arch $(CC_ARCH) -Wunreachable-code $(IFLAGS) "-Isrc" src/paks/est/estLib.c
...
$(CONFIG)/obj/pcre.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) "-Isrc" src/paks/pcre/pcre.c
...
$(CONFIG)/obj/mprLib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/mprLib.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) "-Isrc" src/paks/mpr/mprLib.c
...
$(CONFIG)/obj/mprSsl.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/mprSsl.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) "-Isrc" "-I$(BIT_PACK_MATRIXSSL_PATH)" "-I$(BIT_PACK_MATRIXSSL_PATH)/matrixssl" "-I$(BIT_PACK_NANOSSL_PATH)/src" "-I$(BIT_PACK_OPENSSL_PATH)/include" src/paks/mpr/mprSsl.c
...
ifeq ($(BIT_PACK_EST),1)
    DEPS_15 += $(CONFIG)/bin/libest.dylib
endif
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_15)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 4.5.1 -current_version 4.5.1 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_15) $(LIBS_15) $(LIBS_15) $(LIBS) 
...
$(CONFIG)/obj/makerom.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/makerom.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) "-Isrc" src/paks/mpr/makerom.c
...
$(CONFIG)/bin/makerom: $(DEPS_17)
	...
	$(CC) -o $(CONFIG)/bin/makerom -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/makerom.o" $(LIBPATHS_17) $(LIBS_17) $(LIBS_17) $(LIBS) 
...
$(CONFIG)/obj/service.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/service.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) "-Isrc" src/service.c
...
DEPS_51 += $(CONFIG)/obj/actionHandler.o
DEPS_51 += $(CONFIG)/obj/auth.o
DEPS_51 += $(CONFIG)/obj/basic.o
DEPS_51 += $(CONFIG)/obj/cache.o
DEPS_51 += $(CONFIG)/obj/chunkFilter.o
DEPS_51 += $(CONFIG)/obj/client.o
DEPS_51 += $(CONFIG)/obj/conn.o
DEPS_51 += $(CONFIG)/obj/digest.o
DEPS_51 += $(CONFIG)/obj/endpoint.o
DEPS_51 += $(CONFIG)/obj/error.o
DEPS_51 += $(CONFIG)/obj/host.o
DEPS_51 += $(CONFIG)/obj/log.o
DEPS_51 += $(CONFIG)/obj/monitor.o
DEPS_51 += $(CONFIG)/obj/netConnector.o
DEPS_51 += $(CONFIG)/obj/packet.o
DEPS_51 += $(CONFIG)/obj/pam.o
DEPS_51 += $(CONFIG)/obj/passHandler.o
DEPS_51 += $(CONFIG)/obj/pipeline.o
DEPS_51 += $(CONFIG)/obj/queue.o
DEPS_51 += $(CONFIG)/obj/rangeFilter.o
DEPS_51 += $(CONFIG)/obj/route.o
DEPS_51 += $(CONFIG)/obj/rx.o
DEPS_51 += $(CONFIG)/obj/sendConnector.o
DEPS_51 += $(CONFIG)/obj/service.o
DEPS_51 += $(CONFIG)/obj/session.o
DEPS_51 += $(CONFIG)/obj/stage.o
DEPS_51 += $(CONFIG)/obj/trace.o
DEPS_51 += $(CONFIG)/obj/tx.o
DEPS_51 += $(CONFIG)/obj/uploadFilter.o
DEPS_51 += $(CONFIG)/obj/uri.o
DEPS_51 += $(CONFIG)/obj/var.o
DEPS_51 += $(CONFIG)/obj/webSockFilter.o

LIBS_51 += -lmpr
LIBS_51 += -lpcre

$(CONFIG)/bin/libhttp.dylib: $(DEPS_51)
	@echo '      [Link] $(CONFIG)/bin/libhttp.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 4.5.1 -current_version 4.5.1 "$(CONFIG)/obj/actionHandler.o" "$(CONFIG)/obj/auth.o" "$(CONFIG)/obj/basic.o" "$(CONFIG)/obj/cache.o" "$(CONFIG)/obj/chunkFilter.o" "$(CONFIG)/obj/client.o" "$(CONFIG)/obj/conn.o" "$(CONFIG)/obj/digest.o" "$(CONFIG)/obj/endpoint.o" "$(CONFIG)/obj/error.o" "$(CONFIG)/obj/host.o" "$(CONFIG)/obj/log.o" "$(CONFIG)/obj/monitor.o" "$(CONFIG)/obj/netConnector.o" "$(CONFIG)/obj/packet.o" "$(CONFIG)/obj/pam.o" "$(CONFIG)/obj/passHandler.o" "$(CONFIG)/obj/pipeline.o" "$(CONFIG)/obj/queue.o" "$(CONFIG)/obj/rangeFilter.o" "$(CONFIG)/obj/route.o" "$(CONFIG)/obj/rx.o" "$(CONFIG)/obj/sendConnector.o" "$(CONFIG)/obj/service.o" "$(CONFIG)/obj/session.o" "$(CONFIG)/obj/stage.o" "$(CONFIG)/obj/trace.o" "$(CONFIG)/obj/tx.o" "$(CONFIG)/obj/uploadFilter.o" "$(CONFIG)/obj/uri.o" "$(CONFIG)/obj/var.o" "$(CONFIG)/obj/webSockFilter.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) -lpam 
endif
...
$(CONFIG)/obj/testHttp.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/testHttp.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) "-Isrc" test/src/testHttp.c
...
$(CONFIG)/obj/testHttpGen.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/testHttpGen.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) "-Isrc" test/src/testHttpGen.c
...
$(CONFIG)/obj/testHttpUri.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/testHttpUri.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) "-Isrc" test/src/testHttpUri.c
...
$(CONFIG)/bin/http: $(DEPS_57)
	@echo '      [Link] $(CONFIG)/bin/http'
	$(CC) -o $(CONFIG)/bin/http -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_57) $(LIBS_57) $(LIBS_57) $(LIBS) 
