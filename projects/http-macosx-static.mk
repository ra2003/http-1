...
prep:
	...
	@[ ! -f $(CONFIG)/inc/me.h ] && cp projects/http-macosx-static-me.h $(CONFIG)/inc/me.h ; true
	@if ! diff $(CONFIG)/inc/me.h projects/http-macosx-static-me.h >/dev/null ; then\
		cp projects/http-macosx-static-me.h $(CONFIG)/inc/me.h  ; \
	fi; true
