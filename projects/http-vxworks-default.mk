...
$(CONFIG)/bin/libhttp.out: $(DEPS_42)
...
$(CONFIG)/bin/libmprssl.out: $(DEPS_49)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.out'
	$(CC) -r -o $(CONFIG)/bin/libmprssl.out $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_49) $(LIBS_49) $(LIBS_49) $(LIBS) 
