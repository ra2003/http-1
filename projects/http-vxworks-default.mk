...
$(CONFIG)/bin/libmprssl.out: $(DEPS_50)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.out'
	$(CC) -r -o $(CONFIG)/bin/libmprssl.out $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) 
...
$(CONFIG)/bin/testHttp.out: $(DEPS_54)
